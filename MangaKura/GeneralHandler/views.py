...
def view_wishlist(request):
    user_wishlist = UserToWishlistItem.objects.filter(user=request.user).order_by('title').order_by('-release_date').order_by('-importance_rating').prefetch_related('images')
